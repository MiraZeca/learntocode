	...
	<div class="container">
		<article class="clearfix latest-news">
			<header>
				...
				<time class="date" datetime="2020-07-18"><?php echo $last_news['date']; ?></time>
			</header>
			<div class="col-1-2">
			<a href="novosti.php?id=<?php echo $last_news['id']; ?>"><img class="pic" src="<?php echo $last_news['img']; ?>" alt="<?php echo $last_news['title']; ?>"></a>
			</div>
			<div class="col-1-2">
